...
# of the sidebar.
html_logo = "_static/logo/chemcoord_logo.png"
...
htmlhelp_basename = u'ChemCoorddoc'
...
latex_documents = [
  (master_doc, u'ChemCoord.tex', u'ChemCoord Documentation',
   u'Oskar Weser', u'manual'),
]
...
man_pages = [
    (master_doc, u'chemcoord', u'ChemCoord Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, u'ChemCoord', u'ChemCoord Documentation',
   author, u'ChemCoord', u'One line description of project.',
   u'Miscellaneous'),
]
